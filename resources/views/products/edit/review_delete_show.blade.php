...
@section('content')
    <header class="header">
        <div class="header-left">
            <h2 style="height: 60px; line-height: 60px;">商品レビュー削除確認</h2>
        </div>
...
{{--                    <input type="hidden" name="comment" value="{{ $comment }}">--}}
                    ...
                    <div class="form-group" style="display: flex;">
                        ...
                        <div class="form-inline" style="width: 500px;">
                            ...
                            <div>{!! nl2br(e($review->evaluation)) !!}</div>

                        </div>
                    </div>
                    <div class="form-group btn-wrapper">
                        <form method="POST" id="delete" action="{{ route('products.revieweditdelete') }}">
                            @csrf
                            <input type="hidden" name="review_id" value="{{ $review->id }}">
                        </form>
                        <input form="delete" type="submit" class="btn btn-default-blue" value="レビューを削除する">
                    </div>
                    <div class="form-group btn-wrapper">
